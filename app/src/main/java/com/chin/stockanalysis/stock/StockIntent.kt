...
data class IntentResult(
    ...
    val stockCodes: List<String> = emptyList(),      // 提取出的股票代码
    val stockNames: List<String> = emptyList(),      // 提取出的股票名称
    val confidence: Float = 0.0f,                    // 置信度 0.0~1.0
