    ...
    override suspend fun execute(params: Map<String, String>, ctx: AgentContext): String {
        return withContext(Dispatchers.IO) {
            try {
                ...
                val orders = db.strategyTradeOrderDao().getActiveOrders()
    ...
    override suspend fun execute(params: Map<String, String>, ctx: AgentContext): String {
        return withContext(Dispatchers.IO) {
            try {
                ...
                db.strategyTradeOrderDao().updateStatusByCode(code, "SOLD", reason)
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                val orders = if (code != null) {
                    listOfNotNull(db.strategyTradeOrderDao().getActiveByCode(code))
                } else {
                    db.strategyTradeOrderDao().getActiveOrders()
                }
