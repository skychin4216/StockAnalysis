...
class StrategyDataIntegrityTest {
    ...
    fun testScreenerStrategySignalNameCodePairing() = runBlocking {
        ...
        val stocks = listOf(
            s("sh600519","贵州茅台",1500.0,1495.0,1490.0,1510.0,1480.0,10_000_000L,15_000_000_000.0,0.3,5.0),
            s("sz000858","五粮液",150.0,149.0,148.0,152.0,147.0,20_000_000L,3_000_000_000.0,1.0,1.5),
            s("sz002594","比亚迪",250.0,248.0,247.0,252.0,246.0,15_000_000L,3_750_000_000.0,0.8,2.0),
            s("sz300750","宁德时代",200.0,198.0,197.0,202.0,196.0,25_000_000L,5_000_000_000.0,1.0,2.0),
            s("sh601318","中国平安",45.0,44.5,44.0,45.5,43.8,50_000_000L,2_250_000_000.0,1.0,0.45),
            s("sh688981","中芯国际",50.0,49.5,49.0,51.0,48.5,30_000_000L,1_500_000_000.0,1.0,0.5),
            s("sh600030","中信证券",20.0,19.8,19.5,20.2,19.4,80_000_000L,1_600_000_000.0,1.5,0.3),
            s("sh600036","招商银行",35.0,34.8,34.5,35.3,34.2,40_000_000L,1_400_000_000.0,0.8,0.28),
            s("sz000002","万科A",12.0,11.9,11.8,12.1,11.7,60_000_000L,720_000_000.0,0.8,0.1),
            s("sz002475","立讯精密",30.0,29.8,29.5,30.2,29.4,25_000_000L,750_000_000.0,0.8,0.24),
            s("sh600276","恒瑞医药",45.0,44.5,44.0,45.5,43.8,15_000_000L,675_000_000.0,1.0,0.45),
            s("sz000651","格力电器",38.0,37.8,37.5,38.2,37.2,20_000_000L,760_000_000.0,0.5,0.19),
            s("sh601398","工商银行",5.5,5.48,5.45,5.52,5.42,200_000_000L,1_100_000_000.0,0.4,0.02),
            s("sh600900","长江电力",22.0,21.8,21.7,22.1,21.6,30_000_000L,660_000_000.0,0.5,0.11),
            s("sh601857","中国石油",8.0,7.95,7.9,8.05,7.85,100_000_000L,800_000_000.0,0.6,0.05),
            s("sh601166","兴业银行",16.0,15.9,15.8,16.1,15.7,35_000_000L,560_000_000.0,0.6,0.1),
            s("sz000001","平安银行",11.0,10.9,10.8,11.1,10.7,40_000_000L,440_000_000.0,0.9,0.1),
            s("sh600183","生益科技",25.0,24.8,24.5,25.2,24.4,12_000_000L,300_000_000.0,1.2,0.3),
            s("sz002463","沪电股份",28.0,27.8,27.5,28.2,27.4,10_000_000L,280_000_000.0,1.5,0.42),
            s("sh600549","厦门钨业",12.5,12.4,12.3,12.6,12.2,18_000_000L,225_000_000.0,0.8,0.1, turnoverRate = 0.0),
        )
